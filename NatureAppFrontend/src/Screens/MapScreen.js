...
import {Accuracy, requestForegroundPermissionsAsync, getCurrentPositionAsync} from "expo-location";
...
const MapScreen = () => {
    ...
    <View style={{flex: 1}}>
        <MapView 
            style={styles.map}
            mapType= "hybrid"
            region={{latitude, longitude, latitudeDelta: 0.0900, longitudeDelta: 0.0900}}
        />
    </View>
    );
};
